...
guac_ingredients = [avocado, onion, tomato, cilantro, salt]
...
pico = Recipe.create!(name: "Pico de Gallo", directions: "In a medium bowl, combine tomato, onion, jalapeno pepper (to taste,) cilantro and green onion. Season with garlic powder, salt and pepper. Stir until evenly distributed. Refrigerate for 30 minutes.", cuisine: "Mexican", calories: 120, user_id: cristian.id)
pico_ingredients = [onion, tomato, cilantro, salt]
pico_ingredients.each do |ing|
  pico.ingredients << ing
end

burg = Recipe.create!(name: "The Perfect Basic Burger", directions: "Preheat an outdoor grill for high heat and lightly oil grate. In a medium bowl, whisk together egg, salt and pepper. Place ground beef and bread crumbs into the mixture. With hands or a fork, mix until well blended. Form into 4 patties approximately 3/4 inch thick. Place patties on the prepared grill. Cover and cook 6 to 8 minutes per side, or to desired doneness.", cuisine: "American", calories: 650, user_id: john.id)
